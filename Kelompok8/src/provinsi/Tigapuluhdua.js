...
import "./styles.css";
import hattaImage from "./Image/Tigapuluhdua/pulau hatta.jpg";
import wokuImage from "./Image/Tigapuluhdua/woku komo-komo.jpg";
...
const Tigapuluhdua = () => {
  ...
  const Culture = [
    {
      name: "Pulau Hatta",
      description: ` Pulau Hatta adalah desa dan pulau di kecamatan Banda, Kabupaten
      Maluku Tengah, Maluku, Indonesia. Letak pulau ini ada 25 km di
      sebelah timur Kepulauan Banda.`,
      backgroundUrl: hattaImage
    },
    {
      name: "Woku Komo-komo",
